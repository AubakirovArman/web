...
import { BookOpen, FileText, History, ShieldCheck, ShieldQuestion, SlidersHorizontal, Users } from 'lucide-react';
...
const adminNavItems = [
  ...
  { href: '/admin/audit', label: 'Журнал', icon: History, perm: 'admin' },
];
